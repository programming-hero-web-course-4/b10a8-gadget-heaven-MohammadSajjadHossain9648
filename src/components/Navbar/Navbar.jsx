            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    >
                        ...
                        <NavLink to={'/Statistics'} className={`text-xs ${isHomePage ? "text-white_color" : "text-Shade_black_color_1"}`}>Statistics</NavLink>
                        <NavLink to={'/Dashboard'} className={`text-xs ${isHomePage ? "text-white_color" : "text-Shade_black_color_1"}`}>Dashboard</NavLink>
                    </ul>
                </div>
